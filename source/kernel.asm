...
;
; Copyright (C) 2006 - 2010 MikeOS Developers.
...
option_screen:
	...
	dialog_string_1		db 'Thanks for trying out HeliumOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute HeliumOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of HeliumOS, and', 0
